          ...
          <div>
            <div className={"progress" + " " + stylieng.ProgressDiv}>
              <span
                ...
                role="progressbar"
                style={{ width: props.CoursesDataa.Stars * 20 + "%" }}
                aria-valuenow="50"
                aria-valuemin="0"
                aria-valuemax="100"
              ></span>
          ...
          <div>
            <div className={"progress" + " " + stylieng.ProgressDiv}>
              <div
                className={"progress-bar" + " " + stylieng.StarsColor}
                role="progressbar"
                style={{ width: props.CoursesDataa.Stars * 15 + "%" }}
                aria-valuenow="50"
                aria-valuemin="0"
                aria-valuemax="100"
              ></div>
          ...
          <div>
            <div className={"progress" + " " + stylieng.ProgressDiv}>
              <div
                className={"progress-bar" + " " + stylieng.StarsColor}
                role="progressbar"
                style={{ width: props.CoursesDataa.Stars * 13 + "%" }}
                aria-valuenow="50"
                aria-valuemin="0"
                aria-valuemax="100"
              ></div>
          ...
          <div>
            <div className={"progress" + " " + stylieng.ProgressDiv}>
              <div
                className={"progress-bar" + " " + stylieng.StarsColor}
                role="progressbar"
                style={{ width: props.CoursesDataa.Stars * 5 + "%" }}
                aria-valuenow="50"
                aria-valuemin="0"
                aria-valuemax="100"
              ></div>
